  ...
  return (
    <section id="contact" className="py-20 bg-white">
      <div className="container mx-auto text-center max-w-2xl">
        <SectionHeading className="mx-auto text-center after:mx-auto">Get In Touch</SectionHeading>
        ...
        <div className="flex justify-center mb-12">
          <a href="mailto:parvmunjal100@gmail.com" className="btn btn-primary">
            Say Hello
          </a>
        </div>
        ...
        <div className="flex justify-center gap-6">
          ...
          <a 
            href="mailto:parvmunjal100@gmail.com" 
            className="text-slate hover:text-highlight transition-colors"
            aria-label="Email"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
